...
seed_points = {
    'nominal': [1.2, -0.8, 1.2, -2.1, -1.8, -0.1, -1.2, -2.34, -1.2, -1.04, 1.8, 0.1],
    'left_grasp': [1.65, -1.06, 1.65, -2.13, -1.58, 0.11, -1.2, -2.34, -1.2, -1.04, 1.8, 0.1],
...
X_sugar_right = RigidTransform(RollPitchYaw(0, -np.pi/2, np.pi), [0.0, 0.031, 0.0])
